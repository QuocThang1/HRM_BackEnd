...
const createContract = async (req, res) => {
    try {
        ...
        const data = await createContractService(staffId, content, fromDate, toDate, createdBy);
        res.json(data);
    } catch (error) {
...
const updateContract = async (req, res) => {
    try {
        ...
        const data = await updateContractService(id, content, status, fromDate, toDate);
        res.json(data);
    } catch (error) {
